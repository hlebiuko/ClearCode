...
(function run() {
    ...
    // console.log(`Military airport sorted by max distance: ${Airport.print(airport.getBomberMilitaryPlanes())}`);
    ...
    // console.log(`Temp debug line: ` + airport.getTransportMilitaryPlanes());
    // console.log(`Temp debug line: ` + airport.print( airport.getTransportMilitaryPlanes()));
})();